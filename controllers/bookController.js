...
exports.book_create_post = [
    ...
    // Sanitize fields (using 'wildcard' which sanitises all fields at one go ).
    sanitizeBody('*').escape(),
...
//Commented the ones below out because they are unnecessary
//      async.parallel({
//     book: function(callback) {
...
//       res.render('book_delete', { title: 'Delete Book', book: results.book, book_bookinstances: results.book_bookinstances, bookinstance:  bookinstance } );
//       return;
//     }
//     else{
